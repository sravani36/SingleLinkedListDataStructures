...
namespace SingleLinkedListProject1
{
    class SingleLinkedList
    {
        ...
        /*Important Methods for Insertion*/
        ...
        public void InsertBefore(int data, int x)
        {
            ...
            /* x is in firsst node, new node is to be inserted before first node */
            if (x == start.info)
            {
                temp = new Node(data);
                temp.link = start;
        ...
        public void InsertAtPosition(int data, int k)
        {
            Node temp;
            int i;
            /*If position k value is given 1 then this will execute*/
            if (k == 1)
            {
                temp = new Node(data);
                temp.link = start;
        ...
        /* Method to perform Bubble Sort using data i.e.; info*/
        public void BubbleSortExData()
        {
            Node end, p, q;
            /* This first For loop refers PASS of a bubble sort*/
            for (end = null; end != start.link; end = p)
            {
                /*This second for loop refers what will happen in that PASS */
        ...
        /* Method to perform Bubble Sort using Links */
        ...
        private Node Merge1(Node p1, Node p2)
        {
            ...
            /*If first list has finished and elements left in second list list */
            while (p2 != null)
            {
                pM.link = new Node(p2.info);
                p2 = pM.link;
        ...
        /* This method merges 2 sorted lists using links */
        ...
        private Node MergeSortRec(Node listStart)
        {
            if (listStart == null || listStart.link == null)
                /* This if condition checks wether list is empty or it has at least 1 element */
                return listStart;
        ...
        //    }
        //}
        /*Method to Display all elements in a List*/
        ...
        /* Method which can count number of nodes ina List*/
